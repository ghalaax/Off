...
from off.identity.views.create_identity import IdentityCreate
from off.identity.views.view_identity import IdentityView
from off.identity.views.change_identity import IdentityChange

app_name = 'off.identity'
