...
class OffBlock(models.Model):
    pass


class OffTransaction(models.Model):
    ...
    account_from = models.ForeignKey(
        OffAccount, null=True, on_delete=models.SET_NULL, db_index=True, related_name="transaction_debit")
    account_to = models.ForeignKey(
        OffAccount, null=True, on_delete=models.SET_NULL, db_index=True, related_name='transaction_credit')
...
def create_off_account(sender, instance, created, **kwargs):
    if created:
        OffAccount.objects.create(user=instance)
