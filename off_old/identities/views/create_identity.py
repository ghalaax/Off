...
from off.identities.admin import UserCreationForm
...
class IdentityCreate(SuccessMessageMixin, RedirectNextMixin, CreateView, GenericNavigationMixin):
    model = Identity
    template_name = 'identities/create_identity.html'
    contextbuilder = None
    success_message = _('identity_is_created')
    email_template_name = "identities/emails/registration_email_template.html"
    html_email_template_name = "identities/emails/registration_html_email_template.html"
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            return redirect('off.identities:update_key', off_id=identity.key)
